...
export const worldLanguagesTrack: Track = {
  ...
  nodes: [
    ...
    { courseId: 'ap-spanish-6', row: 3, col: 0, label: 'AP Spanish VI' },
    { courseId: 'spanish-6-hh-cinema', row: 3, col: 0, label: 'Spanish Cinema HH' },
    { courseId: 'french-4-h', row: 3, col: 1, label: 'French IV H' },
    { courseId: 'ap-french-5', row: 3, col: 1, label: 'AP French V' },
    { courseId: 'french-6-hh', row: 3, col: 1, label: 'French VI HH' },
