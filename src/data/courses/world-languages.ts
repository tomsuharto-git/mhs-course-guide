...
export const worldLanguageCourses: Course[] = [
  ...
  },
  {
    ...
    duration: 'full-year',
    description:
      'This course follows the guidelines of the College Board AP Spanish Language and Culture course and provides opportunities for students to demonstrate their proficiency in the three modes of communication (Interpretive, Interpersonal, and Presentational) defined in the Standards for Foreign Language Learning in the 21st century. According to the College Board, successful students in the advanced language course should: "demonstrate an understanding of the culture(s), incorporate interdisciplinary topics (connections), make comparisons between the native language and the target language and between cultures (comparisons), and use the target language in real life settings (communities)." Thematic organized materials will provide students with the skills and strategies that are vital for the Advanced Placement Examination. The six themes explored in this class are: Families and Communities, Science and Technology, Beauty and Aesthetics, Global Challenges, Contemporary Life, and Personal and Public Identities.',
  ...
  },
  {
    ...
    duration: 'full-year',
    description:
      'Spanish Cinema is a course designed to evaluate Spanish films as works of art in a historical, literary, and cultural context. Film is often thought of as entertainment, yet in this class, film will be used as a medium to explore and analyze aspects such as: stylistic elements (narrative, characterization, plot, and symbolism), cultural elements (class, gender, political views, and immigration), and technical aspects of cinema (cinematography, sound, and special effects). The main goal is to expand and strengthen oral proficiency in the Spanish language by focusing on listening comprehension, interactive verbal communication, and essential writing skills. Literary short stories and certain songs will be reviewed in coordination with some of the films.',
    prerequisites: ['ap-spanish-5'],
    tags: ['world-language', 'spanish'],
    fulfills: ['World Language'],
