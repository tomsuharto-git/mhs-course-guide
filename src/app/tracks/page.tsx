  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
      ...
      <p className="text-sm text-text-muted mb-8">
        Visual flowcharts showing how courses connect across grade levels. Click
        a track to see the full pathway.
      </p>
      ...
      <div className="mt-8 p-4 bg-warm-gray rounded-lg text-sm text-text-muted">
        <p>
          <strong>Note:</strong> Flowcharts outline recommended pathways. Actual
